...
export const liveBusinessContent = {
  ...
  business: {
    ...
    sideStories: [
      {
        id: 'business-side-suind-drone-funding',
        slug: 'suind-drone-vision-autonomy-seed-funding',
        title: "The Drone That Thinks for Itself: How SUIND's Rs 20.5 Crore Seed Round and Vision-First Autonomy Platform Are Redefining What Indian Agri-Drones Can Do",
        description:
          "SUIND has raised Rs 20.5 crore to scale its vision-first autonomous drone platform across agriculture, infrastructure inspection, security and defence applications.",
        image: '/suind-funding.png',
        publishedDate: 'August 3, 2026',
        body: [
          "The Indian drone sector has had an extraordinary 2026. IdeaForge raised Rs 500 crore through a qualified institutional placement in July, reinforcing its position as the country's most capitalised domestic drone manufacturer. EndureAir received Rs 30 crore in grant support under the Centre's RDIF scheme in May to develop a 200-kilogram heavy-payload drone platform. IG Defence completed a pre-Series A round of around $5 million in March. Skye Air Mobility was raising a $9 million Series B for drone delivery. The sector is receiving capital, government backing and strategic attention at a rate that would have been difficult to predict even three years ago, and the policy environment driving it, including the Production Linked Incentive scheme for drones and the defence procurement framework's preference for indigenous systems, has created conditions in which genuinely differentiated technology companies can build real businesses rather than simply accumulating demonstration deployments.",
          "SUIND's seed round of Rs 20.5 crore, around $2.1 million, was led by Transition VC, with IIMA Ventures also participating. The round follows an earlier seed raise of Rs 5 crore led by SunICON Ventures, which also saw participation from Zetta Farms and a group of angel investors, nearly three years ago. The fact that SUIND has operated on relatively modest capital while building a commercially deployed product and a proprietary autonomy stack is itself a statement about the technical and operational discipline of the founding team.",
          { type: 'heading', text: 'The Technical Foundation: Why Vision-First Matters' },
          "SUIND develops autonomous unmanned aerial systems that use computer vision instead of relying primarily on GPS for navigation. Its proprietary vision-first autonomy platform enables drones to perceive their surroundings and operate in low-altitude, near-terrain and GPS-denied environments where conventional drones often struggle.",
          "The technical significance of this approach requires some unpacking to appreciate fully. Conventional autonomous drone systems use GPS as their primary positioning reference. The GPS receiver on the drone communicates with satellites to determine its location, and the flight control system uses that location data to execute pre-programmed flight paths, hold position and return to home in the event of a signal disruption. This works well in open environments with clear sky access and reliable satellite signal. It works poorly, or not at all, in environments where GPS signal is degraded, blocked or deliberately jammed.",
          "The agricultural environments where drone spraying is most commercially valuable—plantations, orchards, vineyards and farms with dense tree canopy cover—are precisely the environments where GPS reliability degrades most significantly. Near-terrain flight at low altitude, which is required for effective crop spraying, further compounds the challenge. And for defence and security applications, GPS denial through electronic warfare is an explicit operational threat that any credible unmanned system needs to be designed around from the beginning rather than retrofitted with countermeasures after the fact.",
          "SUIND's computer vision approach replaces GPS-dependent positioning with a system that perceives the physical environment directly. Cameras and sensors on the drone process visual information in real time, allowing the flight control system to understand its surroundings, navigate obstacles, maintain altitude and attitude, and execute missions based on what it actually sees rather than what a satellite tells it its coordinates are. The result is a drone that operates competently in exactly the environments where GPS-dependent systems struggle most.",
          { type: 'heading', text: 'Bumblebee: The Commercial Product That Proves the Technology Works' },
          "The startup claims to have already commercially deployed its DGCA-certified autonomous spraying drone, called Bumblebee, across plantations and farms. According to the company, the platform improves spraying consistency while reducing chemical consumption, operating costs and workers' exposure to agrochemicals.",
          "Bumblebee is the commercial expression of SUIND's autonomy technology in the agricultural domain, and its DGCA certification is a commercially important credential that distinguishes it from research-stage drone platforms that have demonstrated capability in controlled environments but have not yet navigated India's regulatory approval process for commercial deployment. DGCA certification for agricultural drone spraying requires demonstration of technical safety standards, operational reliability and compliance with the airspace and operational rules that govern commercial UAS activity in India.",
          "The value proposition that Bumblebee offers to plantation and farm operators is built around three concurrent improvements that autonomous drone spraying enables relative to conventional manual application methods. Spraying consistency improves because the drone follows precise, repeatable flight paths at consistent altitude and speed, eliminating the variability that characterises manual application by workers carrying or pulling spraying equipment across uneven terrain. Chemical consumption reduces because the autonomous system can calibrate spray output to the specific crop density and coverage requirements of each section of the farm rather than applying a uniform rate across variable conditions. And worker health risk decreases because the human operator is removed from direct contact with the agrochemicals being sprayed, a benefit that is particularly significant for the more toxic pesticide and fungicide formulations used in commercial plantation agriculture.",
          "The combination of these three outcomes produces a business case for agricultural drone adoption that is grounded in measurable operational and financial benefit rather than technology novelty, and that is the kind of customer value proposition that drives commercial deployment at scale rather than pilot programmes that never convert to recurring revenue.",
          { type: 'heading', text: 'WASP: The Surveillance Platform That Extends the Technology' },
          "Building on this technology, SUIND is also developing WASP, an autonomous aerial platform designed for industrial monitoring, security, surveillance and defence applications. The company said it plans to use its proprietary vision-based autonomy stack to enable WASP to operate in complex environments.",
          "The development of WASP alongside the established Bumblebee agricultural platform reflects a technology architecture decision that is strategically intelligent. By building its core autonomy capability as a platform that is application-agnostic at the fundamental level, SUIND can extend the same vision-first navigation and environmental perception technology from agricultural spraying into surveillance, inspection and defence use cases without rebuilding the foundational autonomy stack for each new application.",
          "The surveillance and defence drone market in India is both large and rapidly evolving. The Indian armed forces have expressed urgent operational requirements for domestically produced unmanned systems that can operate reliably in contested electromagnetic environments, including the GPS-denied conditions that characterise potential conflict zones along India's northern borders. Industrial infrastructure operators, including power utilities, pipeline operators, oil and gas installations and port authorities, have growing requirements for autonomous aerial inspection and perimeter surveillance capabilities. Security operators managing large facilities, critical infrastructure and events need persistent aerial surveillance that does not require a trained pilot for every flight hour.",
          "WASP's vision-first autonomy makes it inherently more suitable for all of these applications than GPS-dependent alternatives. An industrial monitoring drone that loses GPS signal in a metal-rich manufacturing environment is not useful. A perimeter surveillance drone that can be disrupted by a consumer-grade GPS jammer provides security theatre rather than actual security. A defence surveillance platform that relies on the same satellite signals that adversaries can target with electronic warfare equipment is operationally vulnerable in precisely the situations where reliability matters most. SUIND's architecture addresses all of these limitations by design rather than as an afterthought.",
          { type: 'heading', text: 'The Capital Deployment Plan: Three Priorities, One Platform' },
          "The startup plans to use the fresh capital to scale the commercial deployment of its agri-drone platform, accelerate the development of its infrastructure inspection drone, strengthen its proprietary autonomous technology and bolster its engineering capabilities.",
          "The allocation of the Rs 20.5 crore across these three priorities reflects a considered sequencing of investment that builds commercial momentum, technology depth and engineering capacity simultaneously rather than making a single concentrated bet on one dimension.",
          "Scaling the commercial deployment of Bumblebee generates revenue that validates the agricultural market thesis and provides the real-world operational data that strengthens the autonomy platform with every deployment. Every plantation and farm where Bumblebee operates adds to the accumulated flight hours, edge case encounters and performance data that makes SUIND's vision-based navigation system more robust and more capable over time. This is the self-reinforcing dynamic that gives autonomous systems companies with deployed products a compounding advantage over competitors that are still in laboratory development.",
          "Accelerating the development of the infrastructure inspection drone, which appears to be an intermediate application between the established agricultural platform and the full WASP surveillance system, creates a second commercial revenue stream that extends the addressable market beyond agriculture while keeping the development investment grounded in near-term commercial applications.",
          "Strengthening the proprietary autonomy technology and engineering capabilities addresses the foundational investment that gives SUIND its durable competitive position. Vision-based autonomous navigation is not a capability that can be purchased off the shelf or replicated quickly by a competitor without significant investment in the specific technical expertise, training data and software infrastructure that makes a real-world autonomous flight system reliable enough for commercial and defence deployment.",
          { type: 'heading', text: 'The Founder Conviction Behind the Investment Thesis' },
          "Cofounder and CEO Kunal Shrivastava articulated the company's foundational philosophy directly: the goal is not simply to manufacture more drones, but to build the intelligence that allows aerial robots to perform complex, repetitive and hazardous work with greater safety, consistency and minimal human dependence.",
          "That framing is important because it defines SUIND's competitive positioning against the dominant narrative in India's drone sector, which has been primarily about manufacturing volume, localisation percentage and cost reduction relative to Chinese alternatives. Those dimensions matter and are commercially significant, particularly in the context of India's push to develop a domestic drone manufacturing ecosystem through the PLI scheme and procurement preferences. But there are dimensions in which competition is primarily about cost and scale rather than about technical differentiation.",
          "SUIND's positioning is as an intelligence company that builds autonomous systems, not as a manufacturer that assembles hardware. The intelligence is the proprietary vision-based autonomy platform that enables its drones to operate where others cannot. That positioning is more defensible over time than cost-based manufacturing competition, and it is the kind of technical moat that the investors backing SUIND's seed round are betting on.",
          "Over the next 12 to 24 months, SUIND plans to scale the manufacturing and commercial deployment of Bumblebee while accelerating the market readiness of WASP. India will remain its primary market and engineering hub, alongside selective expansion into international markets.",
          "The combination of a commercially deployed agricultural platform, a developing surveillance system, a proprietary autonomy technology protected by the accumulated investment of six years of engineering, and a seed round that provides the runway to execute the next phase of both commercial and technical development makes SUIND one of the more carefully constructed deep technology bets in India's drone sector. The Rs 20.5 crore it has raised will not make it the largest or most capitalised drone company in India. But the intelligence it has built, and is continuing to build, into its autonomous systems is the kind of advantage that capital alone cannot buy. That is a more durable position than almost any alternative in a sector that is still in the early stages of determining which companies will matter most when the market reaches its full potential.",
        ],
      },
      {
        id: 'business-side-fintech-ipo-wave-july-30',
        slug: 'india-second-fintech-ipo-wave-zepto-valuation-crisis',
        title: "The Rules Have Changed: India's Second Fintech IPO Wave, Zepto's Valuation Crisis, and the Five Stories Defining India's Tech Economy on July 30, 2026",
        description:
        ...
        body: [
          ...
          "As of now, five fintech startups are in various stages of finalising their IPO plans. Fibe has already filed its draft papers, Moneyview has received SEBI's nod to float its issue, and Navi is eyeing a 2027 listing. KreditBee is also laying the groundwork for a listing, while PhonePe could revive its IPO plans once market conditions improve.",
          "Each of these companies represents a distinct position within India's digital financial services landscape, and their individual stories illuminate the breadth of what the second fintech wave actually encompasses.",
          { type: 'heading', text: 'Fibe (formerly EarlySalary)' },
          "Fibe has spent years building a salaried consumer lending business with a strong focus on credit quality and collection discipline. Its decision to file a draft red herring prospectus reflects a business that has reached the scale and financial consistency needed to withstand the scrutiny that public market investors now apply to consumer lending platforms, particularly after the RBI's tightening of risk weights on unsecured personal loans in late 2023 forced a sector-wide credit quality reckoning.",
          { type: 'heading', text: 'Moneyview' },
          "SEBI's approval positions Moneyview as one of the first dedicated personal finance management and lending apps to access Indian public markets. The company has built its user base around the insight that the most valuable relationship in consumer fintech is the one where a platform understands a user's complete financial picture, translating that into a lending business that can price risk more accurately than platforms with narrower data access.",
          { type: 'heading', text: 'KreditBee' },
          "KreditBee has grown from a personal loan provider into a broader consumer credit platform serving younger urban and semi-urban borrowers. Its inclusion in this cohort reflects the growing comfort of the public market ecosystem with NBFC-model consumer lending businesses that have demonstrated through multiple credit cycles that their underwriting produces acceptable loss rates.",
          { type: 'heading', text: 'PhonePe' },
          "PhonePe is the most consequential name on the list but also the most conditional. The company paused its IPO plans in the first half of 2026 amid the geopolitical uncertainty generated by the West Asia conflict and the resulting market volatility. Its eventual listing, when conditions permit, has the potential to set a valuation benchmark for the entire Indian fintech sector that would reshape how the market prices every other company in the cohort.",
          { type: 'heading', text: 'What the Second Wave Is Doing Differently' },
          "Unlike the growth-at-all-costs mindset of 2021, the current fintech IPO cohort is approaching markets with stronger balance sheets and diversified product lines. Most of these firms have expanded into lending, insurance and wealth management to create multiple revenue pools and better operating leverage.",
          "The diversification strategy is not merely cosmetic. A fintech company that generates revenue from lending, earns distribution fees from insurance and mutual fund products, and collects subscription or transaction income from its core platform has a fundamentally different risk profile from one that depends on a single product category. Single-product dependency means that a regulatory change, a credit cycle turn or a competitive pricing move can affect the entire revenue line simultaneously. Multi-product companies can absorb stress in one category while other streams continue generating income, which produces the earnings stability that public market investors need to support premium valuations.",
          "The biggest difference from the 2021 cycle is what counts as success. Growth is still important, but profitability is now the baseline. Investors are asking tough questions about lending quality and collections, return ratios, capital allocation and cross-sell potential. Years of RBI oversight have also weeded out fragile operational models, leaving a cleaner, more resilient batch of candidates.",
          "The RBI's role in this maturation deserves specific acknowledgment. The regulatory pressure applied to India's digital lending sector between 2022 and 2025 was experienced by many companies at the time as an obstacle to growth. Viewed from the vantage point of mid-2026, it looks more like the quality filter that forced every fintech business to choose between building a genuinely sustainable credit operation and abandoning the field. The companies still standing and preparing to list are, in a meaningful sense, the ones that passed that test.",
          { type: 'heading', text: "Zepto's Valuation Crisis and the Quick Commerce Reckoning" },
          "The most significant single development in the July 30 daily brief is not the fintech IPO wave but the Zepto valuation story, which deserves to be read as both a company-specific development and a broader signal about where India's quick commerce sector sits in the public market's risk assessment.",
          "The quick commerce major is considering delaying its public listing as investors are seeking a much lower valuation than its expectations. While the startup was last pegged at $7 billion in 2025, the valuation under discussion is about $2.5 billion to $3 billion. Zepto has received formal price indications from large institutional investors and is negotiating before deciding whether to proceed with the IPO. Its current draft prospectus remains valid until August 21.",
          "A potential markdown from $7 billion to $2.5–$3 billion is not a negotiating position; it is a fundamental reassessment of what a business in Zepto's position is actually worth at its current financial trajectory. The development comes as investors remain wary of Zepto's cash burn and path to profitability amid high competition in the quick commerce segment. The startup's net loss widened to Rs 5,905 crore in FY26, while the top line doubled year on year to Rs 22,624 crore.",
          "The Zepto situation crystallises the tension running through every growth-stage consumer internet company currently considering a public listing in India. Revenue growth at 100 per cent is genuinely impressive. Losses widening alongside that growth, in a market where Blinkit has already posted five consecutive quarters of improving EBITDA and where Eternal is reporting Rs 92 crore quarterly profits, tells institutional investors that Zepto has not yet found the path to the financial profile that justifies a public market premium. The August 21 DRHP expiry creates a forcing function: either proceed at a valuation that reflects institutional price discipline, or withdraw and return when the numbers tell a different story.",
          { type: 'heading', text: "BharatGen's Sovereign AI Ambitions and the Talent Challenge" },
          "Beyond the IPO conversations, the BharatGen story offers a useful counterpoint to the commercial AI narratives that have dominated Indian technology coverage in 2026. The nonprofit consortium building foundation models for India's linguistic and sectoral contexts is attempting something that most private AI companies are not: training genuinely sovereign multimodal AI without the pressure of LP returns as the primary design constraint.",
          "Over the next 18 months, BharatGen plans to scale four multimodal model families, pursue inference optimisation and build a large-scale data repository. However, BharatGen's CEO Rishi Bal identified hiring, training and retaining AI talent as the biggest challenge for the nonprofit. He also highlighted the lack of patience and comparison with Chinese models as a bigger systemic challenge.",
          "The talent retention problem Bal identifies is one that every serious AI organisation in India faces, but it is more acute for a nonprofit that cannot offer the compensation structures that commercial competitors provide. The comparison with Chinese models is equally worth attention: India's sovereign AI ambitions are being measured against the most aggressive state-backed AI development programmes in the world, and that comparison does not serve the patient, institution-building work that genuinely indigenous AI development requires.",
          "BharatGen aims to reach commercial scale in five years by offering custom models and paid tools to banks and governments, a revenue model that aligns the nonprofit's financial sustainability with the public interest use cases it was designed to serve.",
          { type: 'heading', text: "Kissht's Strong Q1 and BlackBuck's Steady Growth" },
          "Two listed companies added meaningful data points to India's startup earnings season on July 30.",
          "Kissht's consolidated net profit soared 59 per cent year on year to Rs 95.1 crore in Q1 FY27 on the back of operating revenue rising 45 per cent year on year to Rs 669.5 crore. The recently listed NBFC reported an AUM of Rs 8,001 crore, up 61 per cent year on year, while gross NPA stood at 2.25 per cent at the end of June 2026, with 12.25 million customers served to date. Kissht's Q1 performance validates the investment thesis of its May 2026 IPO more convincingly than most listings manage in their first quarterly result as a public company.",
          "BlackBuck reported a 25 per cent year-on-year jump in net profit to Rs 42.2 crore in Q1 FY27, while operating revenue grew 42 per cent year on year to Rs 204.2 crore. The logistics platform served 8.83 lakh customers during the quarter, while monthly transacting customers using two or more services rose 20 per cent year on year to 4.6 lakh.",
          { type: 'heading', text: "Freehand's Enterprise AI Raise: Supply Chain Meets Agentic Automation" },
          "Emerging from stealth mode, supply chain-focused AI startup Freehand raised Rs 718 crore ($75 million) in a round co-led by Battery Ventures and NewRoad Capital Partners. Founded in 2024, Freehand develops AI agents that handle procurement, supplier management, invoice processing, payments and contract compliance. It counts Meta, Unilever, Johnson & Johnson and Pfizer as clients.",
          "The Freehand raise is a data point in the broader enterprise AI funding story that is reshaping how global corporations think about back-office automation. Procurement and supply chain management represent one of the highest-value, most process-intensive domains in enterprise operations, and AI agents capable of handling the complete cycle from purchase requisition through supplier management to invoice settlement and compliance documentation address a genuinely large category of corporate spending on human labour. The client list, spanning technology, consumer goods, healthcare and pharmaceutical industries, suggests the product has achieved a level of reliability across diverse enterprise environments that early-stage AI companies rarely demonstrate.",
          { type: 'heading', text: 'Conclusion' },
          "The five stories from July 30 together paint a picture of an Indian startup economy in the middle of a significant sorting exercise: between companies that built real businesses during the growth era and are now able to prove it to public markets, and companies whose growth was too dependent on capital-intensive customer subsidies to produce the earnings quality that 2026's more demanding investors require. The fintech IPO wave, Zepto's valuation negotiation, BharatGen's patient institution-building, and the quarterly results of Kissht and BlackBuck are all chapters in that same larger story.",
        ],
      },
      {
        id: 'business-side-sedemac-q1-fy27',
        slug: 'iit-bombay-deeptech-sedemac-q1-fy27',
        title: "The IIT Bombay Deeptech That Wall Street Has Not Heard Of: SEDEMAC's Q1 FY27 Numbers Make India's Strongest Case for Patient, Unglamorous Innovation",
        description:
          'SEDEMAC nearly doubled quarterly profit as revenue climbed 42.5 per cent, strengthening the case for patient Indian deeptech built on engineering rigour, manufacturing scale and durable OEM relationships.',
        image: '/SEDEMAC.avif',
        publishedDate: 'August 3, 2026',
        body: [
          "The Indian startup ecosystem's love affair with consumer internet, fintech and AI applications occasionally obscures a simpler and more durable form of value creation: building genuinely useful, technically complex, physical products and selling them in enormous quantities to the companies that make the machines the world runs on. SEDEMAC Mechatronics is that kind of company. It does not have a social media presence that most people would recognise, a product that consumers interact with directly, or a founding story that involves a college dropout or a pivot from an initial idea that failed spectacularly. It has electronic control units deployed in vehicles made by Tata Motors, Bajaj Auto, Hero MotoCorp, Mahindra Group, Ashok Leyland and TVS Motor. It has an IIT Bombay professor who started it in 2007 and is still there. And it has the financial results that the patient, unglamorous, technically rigorous approach to deep technology eventually produces.",
          "The Q1 FY27 numbers are the most recent and clearest expression of what SEDEMAC has built.",
          { type: 'heading', text: 'The Financial Story: Profit Nearly Doubles as Revenue Accelerates' },
          "SEDEMAC Mechatronics' net profit reached Rs 33.3 crore in Q1 FY27, a 95.1 per cent increase from the Rs 17.1 crore recorded in the year-ago quarter. Operating revenue grew 42.5 per cent year on year to Rs 309.8 crore, up from Rs 217.4 crore in Q1 FY26. On a sequential basis, the top line rose 7.7 per cent from Rs 287.7 crore in the preceding quarter, and the company's total income for the quarter stood at Rs 310.6 crore including other income of Rs 86 lakh.",
          "The profit growth rate of 95 per cent is exceptional in any context. In the context of a company that manufactures physical electronic components and is therefore exposed to raw material cost cycles, semiconductor supply chain volatility, and the operational complexity of serving multiple large automotive OEMs simultaneously, it is the kind of result that reflects years of compounding investment in product quality, customer relationships and manufacturing efficiency rather than a single quarter's tactical execution.",
          "SEDEMAC improved its EBITDA by 30 per cent year on year to Rs 60 crore in Q1 FY27. However, its EBITDA margin contracted to 19.4 per cent from 21.2 per cent in the year-ago quarter, primarily due to rising raw material costs and a tightening semiconductor supply chain. The margin compression is a real and honest challenge that deserves attention, but the company's own guidance provides useful context: it expects EBITDA margins to either hold at current levels or improve through the remainder of FY27 relative to Q1. That confidence is not unfounded given the trajectory of the preceding quarters, and it reflects management's assessment that the raw material and semiconductor headwinds, while genuine, are manageable rather than structural.",
          { type: 'heading', text: 'The Segment Story: Mobility Soars, Industrial Pulls Back' },
          "The mobility segment contributed Rs 281 crore to operating revenue during the quarter, a 53.4 per cent increase year on year. The industrial solutions vertical, by contrast, saw revenue decline 15.7 per cent year on year to Rs 28.7 crore in Q1 FY27.",
          "The divergence between the two segments is significant and worth unpacking. The mobility segment, which covers electronic control units for two-wheelers, three-wheelers, commercial vehicles and passenger cars, is benefiting from multiple concurrent tailwinds: rising vehicle production volumes across India's automotive sector, the accelerating transition to fuel-injected engines from carburetted ones in the two-wheeler segment, the growth of electric vehicles requiring sophisticated motor controllers, and the increasing electronic content per vehicle across all categories as emission norms tighten and vehicle sophistication increases.",
          "SEDEMAC's engine control units are the software-defined brains of the internal combustion engine. They manage fuel injection timing, ignition, throttle response, idle speed control and emissions management with a precision that carburetted engines could never approach. As India's two-wheeler market, the world's largest by volume, continues its mandatory transition to fuel injection driven by BS6 and forthcoming BS6 Phase 2 emission standards, every new vehicle produced needs an engine control unit from a supplier capable of meeting the technical and quality requirements of OEMs whose engineering standards are among the most demanding in the world. SEDEMAC has spent nearly two decades building the capability to be that supplier.",
          "The industrial solutions segment's 15.7 per cent revenue decline in the quarter is the only material negative in an otherwise strong set of results. Industrial automation spending in India has been subject to capital allocation variability as companies balance capacity expansion investment against the uncertain demand outlook in certain manufacturing subsectors. The contraction in this segment does not reflect a loss of competitive position or customer relationships, and the company has not suggested it represents a structural trend. It is the natural variability of a segment that depends on project-based industrial capex decisions rather than the more predictable, high-volume, repeating revenue of automotive ECU supply.",
          { type: 'heading', text: 'The Cumulative Milestone: 1.3 Crore ECUs and What It Means' },
          "SEDEMAC said it has cumulatively sold more than 1.3 crore electronic control units to vehicle and industrial OEMs across India, the United States and Europe.",
          "That number deserves to be read slowly. 1.3 crore is 13 million individual electronic control units, each designed, manufactured, tested, validated and shipped to meet the exacting quality and reliability standards that automotive OEMs impose on their Tier 1 and Tier 2 suppliers. Each of those units is embedded in a vehicle or industrial machine that a customer is using every day, in some cases for a decade or more. Every unit that functions without a failure in the field is a data point that tells SEDEMAC's OEM customers something about the company's engineering rigour, manufacturing consistency and quality management discipline.",
          "In the automotive electronics supply chain, this cumulative track record is the most important commercial asset a company can possess. Automotive OEMs do not change electronic component suppliers casually. The qualification process for a new ECU supplier at a major two-wheeler or commercial vehicle manufacturer involves months of validation, thousands of hours of durability testing, and a rigorous audit of manufacturing processes and quality systems before a single unit enters production. Once a supplier is qualified and production volumes are established, the switching cost for the OEM is very high. SEDEMAC's 1.3 crore cumulative ECU deliveries represent 1.3 crore reasons its existing OEM relationships are durable, and a 1.3-crore-unit quality track record that new entrants trying to win the same customers cannot replicate quickly regardless of their technical capability.",
          { type: 'heading', text: 'The Cost Structure and Where the Money Went' },
          "Total expenses grew 41.9 per cent year on year and 9.3 per cent quarter on quarter to Rs 269.3 crore in Q1 FY27. The largest cost category was materials consumed, which rose 40 per cent to Rs 200 crore against Rs 143 crore in Q1 FY26. Employee benefits expense grew 22.2 per cent to Rs 24.2 crore, covering salaries and provident fund contributions. Other expenses increased 62.3 per cent to Rs 32.5 crore compared with Rs 20 crore in the year-ago quarter.",
          "The materials cost increase is the direct expression of the raw material and semiconductor supply chain tightening that the company flagged as the primary driver of EBITDA margin compression. Electronic components, particularly the semiconductor chips that are the core computational elements of any ECU, have been subject to price increases driven by global supply chain restructuring, geopolitical tensions affecting chip manufacturing geography, and sustained demand from the automotive electronics sector as vehicle electrification and sophistication accelerate simultaneously. SEDEMAC is exposed to this dynamic as a high-volume buyer of semiconductors and passive electronic components, and the 40 per cent increase in materials costs reflects both volume growth and per-unit cost increases.",
          "The 62.3 per cent increase in other expenses is a larger movement than the revenue growth rate, which is worth monitoring. Other expenses typically cover items like manufacturing overheads, logistics, utilities, and service and maintenance costs across the production facilities. At the revenue scale SEDEMAC is now operating, some of these cost categories have fixed components that do not scale proportionally with output, and some have variable components that should track revenue growth more closely. A 62 per cent increase against 42.5 per cent revenue growth suggests there may be some one-time or step-up cost elements within the quarter, and the normalisation of this ratio will be an important variable in the margin trajectory the company has guided toward for the remainder of FY27.",
          { type: 'heading', text: 'The Founding Story and Why It Matters' },
          "SEDEMAC was founded in 2007 by Professor Shashikanth Suryanarayana of IIT Bombay, along with Pushkaraj Panse, Sharma and Dixit. The academic founding is not incidental to understanding the company's character. Professor Suryanarayana's background in systems and control engineering, embedded in IIT Bombay's world-class engineering research environment, gave SEDEMAC a foundational technical rigour that most commercially originated startups take years of expensive trial and error to develop. The company began as a research-and-application organisation before evolving into a product company, and the intellectual depth of that origin is visible in the sophistication of its product portfolio and the confidence with which it has qualified its systems with the most demanding automotive OEMs in the Indian market.",
          "The IIT Bombay connection also gave SEDEMAC access to one of India's deepest talent pipelines for the specific skills its business requires: embedded systems engineers, control systems specialists, hardware designers and firmware developers who can work simultaneously at the level of chip-level programming and system-level vehicle integration. In a country where this particular combination of skills is scarce, having a founding team with the institutional relationships and technical credibility to attract it from the best engineering programmes in India is a durable competitive advantage.",
          { type: 'heading', text: "What the Q1 FY27 Results Tell You About India's Deep Technology Future" },
          "SEDEMAC's Q1 FY27 performance is a data point in a larger argument about what Indian deep technology is capable of producing. The argument, stated simply, is this: when Indian engineers with genuine technical depth choose to build physical, embedded, critical technology products rather than software applications or consumer platforms, and when they sustain that commitment through the long qualification cycles and capital-intensive development timelines that hardware technology demands, the results can be globally competitive in ways that pure software companies rarely manage to be.",
          "Shares of SEDEMAC ended Tuesday's trading session 2.38 per cent lower at Rs 2,710.45 on the BSE, a movement that reflects the broader market softness of the day rather than any adverse market reaction to the results themselves. For a company that listed on Indian exchanges in early 2026 with the strong Q4 FY26 results that preceded this quarter by just three months, the stock price movement on any single day is considerably less informative than the trajectory of the underlying business. That trajectory, from an IIT Bombay research lab in 2007 to 1.3 crore ECUs shipped and Rs 310 crore in quarterly revenue in 2026, is one of the most compelling stories in Indian deep technology and one of the least told. The Q1 FY27 results give it one more chapter worth reading carefully.",
        ],
      },
      {
        id: 'business-side-vishal-mega-mart-quick-commerce',
        slug: 'vishal-mega-mart-767-stores-quick-commerce',
        title: 'The Value Retailer That Chose Speed: How Vishal Mega Mart Is Using Its 767 Stores to Win the Quick Commerce Race Without Building a Single Dark Store',
        description:
          'Vishal Mega Mart is scaling quick commerce across 767 stores and 520 cities by turning its existing retail footprint into fulfilment infrastructure instead of building a separate dark-store network.',
        image: '/vishal.webp',
        publishedDate: 'August 3, 2026',
        body: [
          "India's traditional retail sector has spent the past three years watching quick commerce eat into its customer base with a mixture of anxiety and uncertainty about how to respond. The dominant strategic options available to a legacy retailer facing this disruption are not particularly attractive. Building a dark store network from scratch requires capital, time and operational capabilities that most traditional retailers do not possess and cannot develop quickly. Listing on aggregator platforms like Blinkit or Zepto means competing for visibility on someone else's infrastructure, paying commissions that compress already thin retail margins, and ceding the direct customer relationship that is a traditional retailer's most valuable long-term asset. Doing nothing means watching the most valuable customers—the frequent buyers who visit weekly for top-up purchases and daily essentials—migrate toward platforms that deliver what they need before they can drive to the store.",
          "Vishal Mega Mart chose a fourth option. It decided to turn its existing physical store network into a quick commerce fulfilment infrastructure, delivering within 30 minutes from stores that were already built, already staffed and already stocked. The model eliminated the capital requirement of dark store construction, the operational complexity of building a parallel logistics network, and the customer relationship disruption of routing orders through a third-party platform. What it required instead was investment in technology, in picking and packing workflow optimisation within existing stores, and in the last-mile delivery partnerships that could execute on the 30-minute promise reliably across a network of 767 locations.",
          { type: 'heading', text: 'The Numbers That Made the Q1 Earnings Call Significant' },
          "Vishal Mega Mart's quick commerce network has expanded to 767 stores across 520 cities, with the number of registered users crossing 1.4 crore. Those are the infrastructure numbers. The commercial numbers are the ones that tell you whether the infrastructure is working.",
          "Managing director and CEO Gunender Kapur said that quick commerce is currently contributing in a range of 2 to 9 per cent to a store's revenue. In a majority of stores the contribution is at least 5 per cent of store revenue, which Kapur described as the goal the company had set when it began the journey. In its best-performing locations, the contribution is reaching 9 to 10 per cent.",
          "The significance of those numbers requires context. When Vishal Mega Mart entered quick commerce in 2024, the internal target of 5 per cent of store revenue from quick delivery was a credibility test rather than a conservative benchmark. Most analyst commentary at the time of the launch treated it sceptically: quick commerce in India had been defined by purpose-built dark store operators with significant venture capital backing, and the idea that a value retailer serving India's mass market could meaningfully participate in the category using its physical store network was an untested proposition. The Q1 FY27 confirmation that the majority of locations have reached the 5 per cent target, and that the best locations are approaching 10 per cent, resolves that scepticism with commercial evidence rather than strategic narrative.",
          { type: 'heading', text: 'The Customer Profile: Higher Baskets and New Faces' },
          "The average order value on quick commerce for Vishal Mega Mart is around Rs 800, slightly higher than the average spend from offline shoppers visiting its stores in person. More significantly, 20 per cent of quick commerce customers have never shopped at Vishal Mega Mart's physical stores, making them entirely new customers for the brand.",
          "Both of those data points are strategically important, and they deserve to be examined separately.",
          "The higher average order value on the quick commerce channel is counterintuitive at first glance. Quick commerce is most commonly associated with top-up purchases and impulse orders—the forgotten ingredient, the emergency household staple, the late-night craving. These are by nature smaller basket occasions. The fact that Vishal Mega Mart's quick commerce orders average higher than its in-store transactions suggests that its customers are using the quick delivery channel for planned, considered purchases rather than purely for emergency top-ups. That behavioural pattern, if it persists at scale, is commercially more durable than a quick commerce model built on impulse and convenience alone, because planned purchases with higher baskets generate better unit economics per delivery.",
          "The 20 per cent new customer figure is even more significant from a long-term strategic perspective. Vishal Mega Mart has built its business over decades by targeting India's mass market consumer, the value-conscious household in Tier II and Tier III cities that wants quality products at affordable prices and is willing to visit a large-format store to get them. The quick commerce channel is reaching a customer segment that either cannot access its physical stores conveniently, prefers the delivery format, or was simply not being served by the traditional walk-in model. Every one of those 20 per cent represents a relationship that would not exist without the quick commerce investment, which means the channel is doing genuine incremental business development rather than simply converting existing store visitors into digital orders.",
          { type: 'heading', text: 'The Strategic Logic: Why the Store-Fulfilment Model Works for Vishal' },
          "The model Vishal Mega Mart has chosen is structurally different from the dark store model that Blinkit, Zepto and Swiggy Instamart have built, and the differences are not just operational. They are economical.",
          "A dark store operator builds dedicated inventory fulfilment centres in dense urban neighbourhoods, optimised for picking speed and delivery radius rather than for the customer experience of physical retail. The capital to build each dark store, stock it with inventory and staff it for round-the-clock operation is invested before the first order is taken. Unit economics improve only as order density increases to the point where the fixed costs of the dark store are covered by the contribution margin of individual orders. In markets where multiple dark store operators are competing for the same customers, achieving that density requires either aggressive discounting or very long runways of cash consumption.",
          "Vishal Mega Mart's store-fulfilment model inverts this economics. The physical store already exists, is already paid for or leased, and already carries inventory that is being sold through the offline channel regardless of whether a quick commerce order arrives. The marginal cost of adding quick commerce fulfilment to a store that is already operational is primarily the technology investment in order management and picking workflow, plus the last-mile delivery cost per order. There is no incremental fixed cost equivalent to building a new dark store. The model scales by adding quick commerce capability to existing stores rather than by building new infrastructure, which means the capital efficiency of expansion is dramatically higher than the dark store approach.",
          "This is why Vishal Mega Mart can operate across 520 cities with 767 stores today. A dark store operator at equivalent geographic coverage would require capital investment that very few companies in Indian retail history have had access to. Vishal's existing physical footprint is, in effect, a pre-built quick commerce network that requires only the software and logistics layer to activate.",
          { type: 'heading', text: 'The DMart Contrast: Two Philosophies, One Sector' },
          "The Vishal Mega Mart strategy stands in direct contrast to DMart's approach. DMart has acknowledged that quick commerce is becoming a permanent part of the retail ecosystem but has ruled out competing on ultra-fast deliveries. Instead it plans to focus on its Everyday Low Price proposition and scale DMart Ready by improving customer density, operating efficiencies and profitability rather than pursuing aggressive expansion or smaller delivery windows.",
          "The contrast between the two companies is not simply tactical. It reflects fundamentally different theories about what kind of threat quick commerce poses to traditional large-format grocery retail and what the appropriate response is.",
          "DMart's position is essentially that its value proposition—the lowest prices on a wide range of grocery and general merchandise delivered through a large-format store experience—is sufficiently durable to retain the customers who value price above all else, and that competing on delivery speed would require capital investment and margin compression that would undermine the very proposition that makes DMart distinctive. The company is betting that a significant portion of Indian grocery shoppers will continue to prefer the planned, basket-building, low-price shopping trip to the convenience premium of quick delivery.",
          "Vishal Mega Mart's position is that consumer behaviour has shifted sufficiently, and permanently enough, that a retailer serving the mass market cannot afford to ignore the quick delivery expectation without losing meaningful customer share to competitors who will serve it. By building quick commerce capability on its existing store infrastructure rather than treating it as a separate business requiring fresh capital, the company has made a bet that is lower-risk than a pure dark store play while still positioning it to capture the convenience-seeking segment of its customer base.",
          "Both approaches could be right for their respective customer profiles. DMart's customer base skews toward planned, bulk, price-optimised grocery shopping where the drive to a well-stocked hypermarket is a rational choice. Vishal Mega Mart's mass market customer base, spread across a far broader geographic footprint including smaller cities where quick commerce alternatives have much thinner penetration, may have a different relationship with the convenience premium and a different expectation of what their preferred retailer should offer.",
          { type: 'heading', text: "What the Quick Commerce Numbers Mean for India's Retail Landscape" },
          "The broader significance of Vishal Mega Mart's Q1 FY27 quick commerce data extends beyond one company's results. It is evidence, at meaningful commercial scale, that the store-fulfilment model for quick delivery is viable for traditional retailers, not just for purpose-built dark store operators.",
          "According to Inc42 Datalabs' projections, quick commerce players in India are expected to generate 68 billion dollars in gross merchandise value by 2031. The assumption embedded in most analysis of that figure is that the value will be captured almost entirely by the current dark store leaders. Vishal Mega Mart's numbers suggest that traditional retailers with large store networks, efficient inventory management and the organisational discipline to implement picking and delivery workflows at scale can participate in that market without building the infrastructure from scratch.",
          "The 1.4 crore registered users that Vishal's quick commerce platform has accumulated are not Blinkit users or Zepto users who have been converted. They are Vishal Mega Mart customers who have been given a new way to access a retailer they already trust, in a format that fits their current expectations of convenience. Building that kind of loyalty through quick commerce, rather than competing with pure-play platforms on the subsidised economics that Blinkit and Zepto use for customer acquisition, is a fundamentally different and potentially more sustainable commercial model.",
          "The Q1 FY27 earnings call confirmed that the model is working at the locations where it has been implemented. The next question, which the company's expansion plans will answer over the coming four to six quarters, is whether it works across the full 767-store network at the consistency and order volume that make it a meaningful driver of overall company revenue rather than a promising pilot at scale.",
        ],
      },
      {
        id: 'business-side-flipkart-food-delivery',
        slug: 'flipkart-food-delivery-digital-mall',
        title: "The Digital Mall Gets a Food Court: How Flipkart's Entry Into Food Delivery Is About Far More Than Feeding People",
        description:
          "Flipkart is preparing a Bengaluru food-delivery pilot that will put it against Zomato, Swiggy, and Rapido's Ownly—and add a high-frequency habit to its expanding digital-commerce ecosystem.",
        image: '/30.webp',
        publishedDate: 'July 27, 2026',
        body: [
          "Flipkart is preparing to enter India's food delivery market with a Bengaluru pilot expected to roll out within weeks. The move will put the Walmart-backed ecommerce giant in direct competition with Zomato, Swiggy, and Rapido's Ownly. But for anyone watching closely, this is not really a story about food. It is a story about what Flipkart is trying to become, and what that ambition reveals about where the entire Indian consumer internet industry is heading.",
          "There is a mental model that explains almost every strategic decision that India's largest consumer internet companies are making in 2026, and it begins with a simple observation about physical retail. A good shopping mall does not just house a few anchor stores. It houses an anchor department store, a supermarket, a multiplex, a food court, a fashion district, a bookshop, a gym, and a dozen other formats that collectively ensure its customers have a reason to come back not once a month but several times a week. The food court is not the most profitable part of the mall. It is the most important part, because it keeps people in the building longer, increases the average number of visits, and creates the daily habit of presence that turns a mall from a destination into a default.",
          "Flipkart is building a digital version of that mall. And it just decided its digital mall needs a food court.",
          "People familiar with the company's plans told Inc42 that Flipkart is expected to launch its food delivery service within the coming weeks, starting with a pilot in Bengaluru before evaluating the strategy for wider expansion. The service will follow a marketplace model, connecting customers with restaurant partners rather than building its own cloud kitchens, and will tap the ONDC network to onboard restaurant supply at scale. The food court has arrived.",
          { type: 'heading', text: 'Why Food Delivery and Why Now' },
          "The timing of Flipkart's food delivery move is not accidental. The company entered quick commerce last year through Flipkart Minutes, a move that attracted significant scepticism at the time given the already dominant positions of Blinkit, Zepto, and Swiggy Instamart in the category. The sceptics argued that Flipkart was too late, too slow, and entering a market where the competitive dynamics were already settled. What the sceptics underweighted was the distribution advantage that Flipkart's 500 million registered users represents when you are trying to build daily usage habits rather than occasional purchase occasions.",
          "Quick commerce gave Flipkart the daily touchpoint it lacked. When a consumer opens the Flipkart app every other day to order groceries or daily essentials through Minutes, they are building a habit that is structurally different from the monthly or occasional visit that characterises traditional ecommerce. Food delivery, ordered multiple times a week by the most frequent users of platforms like Zomato and Swiggy, is an even more frequent touchpoint. A consumer who uses Flipkart for both quick commerce and food delivery is opening the app potentially every single day. That daily active user is fundamentally more valuable than a monthly active user, regardless of the basket size on any individual visit.",
          "The strategic logic is therefore straightforward: food delivery is not primarily a revenue opportunity for Flipkart. It is a frequency and engagement mechanism that makes the entire Flipkart ecosystem more valuable by increasing the proportion of its registered user base that qualifies as genuinely daily active.",
          { type: 'heading', text: 'The Marketplace Model and the Restaurant Partner Opportunity' },
          "The specific product decision that Flipkart has made about how to enter food delivery is worth examining carefully. The company will not build cloud kitchens, will not develop proprietary food brands, and will not invest in the operational infrastructure of a production-focused quick commerce food model like those pursued by Zepto Cafe, Blinkit's Bistro, or Swish. It will connect customers with existing restaurant partners through a marketplace model, essentially replicating the structural approach that Zomato and Swiggy have used to build their dominant positions.",
          "That is a deliberate choice, and not merely a cautious one. Running cloud kitchens introduces a category of operational complexity, real estate dependency, food safety regulatory exposure, and capital intensity that a marketplace model entirely avoids. By staying on the demand aggregation and logistics coordination side of food delivery rather than the production side, Flipkart keeps its cost base lighter, its operational risk lower, and its path to profitability less dependent on the brutal unit economics of food production at scale.",
          "The more significant dimension of the marketplace model is what it means for the restaurant partner ecosystem. India's restaurant owners have been vocal for years about their grievances with the Zomato and Swiggy duopoly. Commission rates between 18 and 28 per cent of order value, mandatory advertising spend requirements to maintain visibility on the platforms, and promotional campaign obligations that compress already thin restaurant margins have created a reservoir of genuine frustration among food service businesses of all sizes. Rapido's Ownly built its early traction in Bengaluru explicitly on this frustration, positioning itself as a lower-cost alternative that would treat restaurant partners more equitably.",
          "Flipkart enters this conversation with a structural advantage that Rapido does not have: it already has a zero-commission policy it extended this month to all fashion sellers on its platform, a signal about how it thinks about marketplace economics at scale. While the specific commission rates and incentive structures for food delivery have not yet been disclosed, the directional signal is that Flipkart will use its financial firepower, backed by Walmart, to offer restaurant partners terms that make joining its platform commercially attractive relative to what they currently pay the duopoly.",
          { type: 'heading', text: 'The Ecosystem Architecture: What Flipkart Is Actually Building' },
          "Step back from the food delivery announcement and look at the full architecture of what Flipkart has assembled over the past several years, and the strategic coherence of each individual move becomes much clearer.",
          "The core marketplace covers electronics, appliances, home decor, general merchandise, and consumer goods across every major category. Myntra gives Flipkart one of India's largest online fashion platforms, serving a demographic that shops for clothing and accessories multiple times per season. Cleartrip provides the travel booking capability that converts Flipkart's consumer relationship into a presence at one of the highest-value transactional moments in an Indian household's calendar. Flipkart Minutes delivers the daily and weekly grocery and essentials shopping that keeps the app relevant between major purchase occasions. And now food delivery will add the multiple-times-per-week touchpoint that represents the highest frequency consumer habit in the digital commerce space.",
          "Beyond these existing categories, Flipkart is also evaluating an entry into live event ticketing, which would put it in direct competition with BookMyShow and Eternal's District for the entertainment spending category. If that move proceeds, Flipkart would cover the complete spectrum of significant consumer spending categories: daily essentials through quick commerce, prepared food through delivery, fashion through Myntra, electronics and home through its core marketplace, travel through Cleartrip, and live entertainment through ticketing.",
          "The user who owns a smartphone purchased on Flipkart, orders groceries through Minutes, books flights on Cleartrip, shops for fashion on Myntra, and orders dinner on Flipkart Food is not a Flipkart customer. They are a Flipkart resident, and that distinction is the entire point of the strategy.",
          { type: 'heading', text: 'The Challenges That Will Determine Whether It Works' },
          "The strategic logic is compelling and the user base advantage is real, but food delivery has destroyed value and reputation for many companies that entered it with confidence and capital. The operational execution requirements of food delivery, managing delivery fleet density, ensuring order accuracy, handling merchant partner relationships at scale, and maintaining customer service quality across an enormous volume of small-value transactions, are genuinely demanding and genuinely different from the operational requirements of traditional ecommerce or even quick commerce.",
          "The consumer behaviour challenge is equally significant. Zomato and Swiggy users are habitual in a way that is genuinely difficult to disrupt. They have saved their favourite restaurants, their default addresses, their payment preferences, and their order history in apps they have used for years. Convincing them to replicate that infrastructure in a new app, even one they already use for other purposes, requires either a significantly better experience or significantly better economics, and ideally both simultaneously.",
          "Rapido's Ownly has attempted to create that alternative in Bengaluru with some early success, but it remains confined to one city and is still in the early stages of proving whether its model scales. Flipkart's entry into the same city for its pilot creates an interesting triangular dynamic: the established duopoly of Zomato and Swiggy, the independent challenger Ownly, and now the ecosystem player Flipkart, each with a different theory of why consumers should choose them.",
          { type: 'heading', text: 'What This Means for the Indian Food Delivery Landscape' },
          "Flipkart's entry into food delivery is the most significant structural event in the category since Rapido launched Ownly. It introduces, for the first time, a platform with genuine ecosystem leverage attempting to compete in a market that has been defined by specialists. The question it poses to Zomato and Swiggy is not whether Flipkart can match their food delivery product in isolation, but whether consumers who already have a deep relationship with the Flipkart ecosystem will increasingly consolidate their daily digital activity there rather than maintaining separate apps for separate functions.",
          "For restaurant partners who have spent years feeling trapped by the duopoly's commission structures, Flipkart's arrival represents the most credible large-scale alternative to date. For consumers, it represents the possibility, not yet a reality, of a single digital home for everything they spend money on every day. For Zomato and Swiggy, it represents the beginning of a competitive dynamic they have not faced from a company of Flipkart's scale, distribution depth, and financial backing.",
          "The food court has opened. The digital mall now has everything. Whether it gets the foot traffic it is designed to attract will be the most closely watched consumer internet story of the next twelve months.",
        ],
      },
      {
        id: 'business-side-paytm-ai-infrastructure',
        slug: 'paytm-ai-infrastructure-enterprise-software-business',
        title: "Beyond Payments: How Paytm's Quiet AI Infrastructure Bet Is Becoming Its Most Ambitious New Business",
        description:
          "With its payments recovery established, Paytm is preparing to commercialise the AI platforms it built internally for merchant intelligence, fraud detection, and operational automation.",
        image: '/29.jpg',
        publishedDate: 'July 27, 2026',
        body: [
          "Paytm has spent the better part of two years rebuilding its core business after the RBI's action on Paytm Payments Bank in early 2024 disrupted what had been one of India's most dominant fintech platforms. That rebuilding is largely complete. The Q1 FY27 results, which showed a 79 per cent jump in net profit to Rs 220 crore and a 28 per cent rise in revenue from operations to Rs 2,448 crore, confirm that the core business has not just recovered but accelerated. Now, with profitability established and the payments business growing faster than the overall UPI market, founder and CEO Vijay Shekhar Sharma is revealing the next chapter: an enterprise AI software business built on tools that Paytm has been quietly developing and deploying internally for several years, which the company now intends to package and sell to the merchants and businesses that already form its commercial ecosystem.",
          "The timing of Paytm's AI ambition is not accidental. The company has been building artificial intelligence capabilities in-house throughout its turnaround period, treating AI not as a strategic announcement but as an operational necessity. Two platforms sit at the centre of what it has built. The first is Paytm ARMS, a merchant lifecycle insights platform that uses AI to understand merchant behaviour, predict churn, optimise retention, and improve the commercial relationship between Paytm and the millions of businesses that use its payment infrastructure. The second is Paytm Pi, an in-house fraud detection platform that uses machine learning to identify suspicious transactions in real time across the company's enormous payments volume.",
          "Both platforms have been running in production at scale inside Paytm for long enough to demonstrate that they work. Merchant onboarding has been partially automated. Customer segmentation and pricing optimization are being handled by AI-driven systems rather than manual analytical processes. Field sales planning, which previously required experienced managers to decide which merchants deserved visits from territory executives, is now guided by an AI agent that analyses merchant data and generates visit recommendations. What had been human-intensive operational work has progressively been converted into automated, algorithmically driven workflow, reducing both the time required and the dependency on headcount to execute.",
          "The decision to sell these tools externally rather than keep them proprietary is the strategic inflection that Sharma announced on the Q1 FY27 earnings call. His framing was direct: having built AI capabilities that demonstrably work inside one of India's most complex business environments, the company sees no reason to restrict their value to internal use. The merchant and business network that Paytm has built over more than a decade is the natural distribution channel for exactly this kind of enterprise AI software, and the trust relationships that Paytm has established with those merchants are the commercial foundation on which software sales can be built.",
          { type: 'heading', text: 'The Technical Stack Behind the Commercial Ambition' },
          "Understanding what Paytm is actually selling, or planning to sell, requires some appreciation of the technical choices the company has made in building its AI infrastructure. Rather than deploying general-purpose large language models at full scale, which carries significant inference cost particularly in a market as price-sensitive as India, Paytm has taken the approach of optimising a base large language model into a smaller, more efficient model specifically calibrated for Indian languages and Indian business contexts, and deploying it on its own infrastructure rather than through external cloud providers.",
          "This approach has two significant commercial advantages. The first is cost: smaller, optimised models running on owned infrastructure are substantially cheaper to operate at the inference volumes that a company serving millions of merchants would generate. The second is performance: models fine-tuned for Indian linguistic and commercial contexts will produce more relevant and accurate outputs for Indian business use cases than general-purpose English-language models applied to the same problems without contextual adaptation.",
          "The resulting AI stack is what Paytm is now proposing to commercialise. Sharma described the current revenue from these products as generating a few lakhs, acknowledging that the enterprise AI business is at an early commercial stage rather than a mature revenue line. But he also expressed confidence that within the next year, the business could become meaningful enough to be broken out as a separate reporting segment under the company's Commerce Cloud vertical. The Commerce Cloud segment is where Paytm groups its non-payments, non-financial services revenue, and giving enterprise AI its own reporting line within it would signal both the scale it has reached and the strategic priority the company attaches to it.",
          { type: 'heading', text: 'Enterprise, Not Consumer: The Deliberate Positioning' },
          "One of the clearest strategic choices Paytm has made in its AI business is the explicit decision to focus entirely on enterprise customers rather than consumers. When an analyst on the Q1 earnings call asked Sharma about consumer AI products, his response was unambiguous: the company has consciously chosen not to pursue that direction. The reasoning reflects a clear-eyed assessment of where Paytm's competitive advantages are most relevant and where the commercial opportunity is most defensible.",
          "Paytm's strength is in its merchant and business relationships, its transaction data across millions of commercial interactions, and its deep operational understanding of how Indian businesses of different sizes manage payments, lending, customer relationships, and compliance. These are enterprise advantages, not consumer advantages. A consumer AI product would require competing in a market dominated by global platforms with enormous model investments, vast training data, and consumer brand recognition that Paytm does not have in the AI context. An enterprise AI product targeting the merchants and businesses that already sit within Paytm's ecosystem is a fundamentally different competitive proposition: it leverages existing relationships, existing trust, and existing data rather than requiring the company to build new ones from scratch.",
          "Sharma was also specific about the differentiation within the enterprise segment. Small businesses will receive a different kind of service than large enterprises, reflecting both the different use cases that apply at different scales and the different commercial models that are sustainable for customers with different resource levels. The granularity of that positioning suggests that the product and commercial design of the enterprise AI business has progressed beyond conceptual framing into actual product planning.",
          { type: 'heading', text: 'The Dual Role of AI: Efficiency and Revenue' },
          "CFO Madhur Deora's comments on the Q1 earnings call added important context to the AI narrative by articulating the dual role that artificial intelligence is playing in Paytm's financial trajectory. The first role is internal efficiency: AI is already enabling the company to grow its revenues without proportionate growth in operating costs, creating the operating leverage that is driving margin expansion even as the business scales. Indirect expenses are growing significantly more slowly than revenue, and AI-driven automation of operational workflows is a primary mechanism through which that discipline is being maintained.",
          "The second role is the one Sharma emphasised more prominently: AI as a direct revenue-generating business in its own right. The two roles are mutually reinforcing. The internal deployment of AI tools, done at scale across a real business handling genuine commercial complexity, produces the proof points and the refined product capabilities that make those tools credible and valuable to external enterprise customers. A company that has deployed AI for merchant retention and achieved measurable improvements in retention rates has something considerably more persuasive to sell than a company that has built AI tools in a research environment and is proposing to sell them based on theoretical capability.",
          { type: 'heading', text: 'The Core Business Foundation That Makes the AI Bet Credible' },
          "The enterprise AI ambition rests on a core payments and financial services business that is performing at its strongest level since the regulatory disruption of early 2024. Payments revenue of Rs 1,384 crore represented over 56 per cent of total revenue from operations in Q1 FY27, with consumer payment volumes growing at nearly twice the pace of the overall UPI market. The company's daily active users and transaction volumes have surpassed the levels seen before the January 2024 disruption, representing a full recovery of the user base that was temporarily impacted.",
          "Financial services has established itself firmly as Paytm's second growth engine, with revenue rising 45 per cent year on year to Rs 814 crore in Q1, driven by merchant loans, personal loans, equity broking, and wealth management products. The merchant subscription business, built around Soundbox and other payment devices, continues to grow as device deployments increase and software adoption among merchants deepens.",
          "The company has also taken a significant step toward rebuilding another piece of its consumer payments infrastructure: it has reapplied for a Prepaid Payment Instrument wallet licence, which was effectively dormant after the Paytm Payments Bank restrictions. Approval of a PPI wallet would allow Paytm to reintroduce wallet-to-UPI payment functionality, which carries an interchange fee and would add a revenue stream to the consumer payments business that has been absent since 2024. The commercial logic of the PPI reapplication is specific and meaningful: wallet-based UPI transactions generate interchange revenue that account-to-account UPI transactions do not.",
          { type: 'heading', text: 'What the Market Is Actually Watching' },
          "Brokerages responded to the Q1 results with a series of target price upgrades, reflecting confidence in the improving profitability trajectory. Morgan Stanley projects EBITDA margins reaching approximately 19 per cent by FY29. JPMorgan highlighted strong margin expansion in the quarter attributed to disciplined cost control. Goldman Sachs and Citi cited market share gains in payments, improving profitability, and lower cloud infrastructure costs as the primary drivers of their positive assessments.",
          "The caution in the analyst community, led most explicitly by CLSA, centres on two specific concerns. Payment take rates remain under pressure as the UPI ecosystem evolves. And the optimism around a potential return of UPI merchant discount rate, which would represent a significant revenue expansion for all UPI participants including Paytm, may already be embedded in the stock price without any regulatory confirmation that MDR will actually be reintroduced. These are legitimate structural questions that the next several quarters of results will need to address.",
          "But the more fundamental question that the market is now asking about Paytm is different from the one it was asking eighteen months ago. The question then was whether the company could survive the regulatory disruption and return to profitability. That question has been answered. The question now is whether Paytm can build a genuinely new and large business outside payments and financial services, whether its enterprise AI ambition is a real commercial opportunity or a narrative constructed to maintain investor enthusiasm during a period of core business recovery.",
          "The Q1 FY27 numbers establish that the core business is strong enough to fund and support the AI investment without compromising profitability. The AI tools themselves have been validated in production at scale. The distribution channel, Paytm's merchant network, is the right channel for the product. The next twelve months will determine whether the commercial execution can convert those structural advantages into a revenue line that justifies the strategic attention Vijay Shekhar Sharma is directing toward it. If it can, Paytm in 2027 will look like a genuinely different company from the one that was fighting for its survival in 2024. That is the dream Sharma is building toward. The question is not whether it is a credible dream. It is whether the execution that follows the Q1 FY27 earnings call is equal to it.",
        ],
      },
      {
        id: 'business-side-albinder-dhindsa',
        slug: 'discount-war-is-over-albinder-dhindsa',
        title: "The Discount War Is Over: Why Eternal CEO Albinder Dhindsa Believes Quick Commerce Is Finally Growing Up",
        description:
          "Eternal CEO Albinder Dhindsa argues that quick commerce has reached peak competitive intensity and that the era of deep discounting is ending — shifting the battleground to infrastructure and unit economics.",
        image: '/Albinder.avif',
        publishedDate: 'July 22, 2026',
        body: [
          { type: 'heading', text: "The Discount War Is Over: Why Eternal CEO Albinder Dhindsa Believes Quick Commerce Is Finally Growing Up" },
          `For three years, India's quick commerce sector ran on a simple and brutally expensive logic: whoever discounts most aggressively wins. Platforms poured capital into customer incentives, slashed delivery fees, subsidised groceries below cost, and accepted mounting losses as the price of market share. On July 22, 2026, Eternal CEO Albinder Dhindsa said something that the industry has been waiting to hear: we are at peak competitive intensity, and it is not going to get worse from here. The implications of that statement, if he is right, reshape the investment thesis, the unit economics, and the strategic direction of every player in India's Rs 1 lakh crore quick commerce market.`,
          `India's quick commerce sector is one of the most capital-intensive consumer internet categories the country has produced. The model requires dense networks of dark stores positioned close enough to consumers to enable 10 to 15 minute delivery, fleets of delivery partners available around the clock, sophisticated inventory management across thousands of SKUs, and the kind of pricing that makes the economics work for consumers at the volumes needed to generate positive contribution margins. Getting all of those variables right simultaneously is genuinely hard. And doing it while three or four well-funded competitors are simultaneously trying to win the same customers through deeper discounts, more aggressive expansion, and more generous promotional offers makes it harder still.`,
          `Dhindsa described Q1 FY27 as the most aggressive phase of competition the quick commerce industry has witnessed to date, driven by both a larger number of players and higher spending on customer incentives across the board. The quarter saw both Amazon and Flipkart announce significant expansion plans and investment commitments in quick commerce, adding credible institutional firepower to a sector that was already intensely competitive. Zepto filed an updated draft red herring prospectus for an IPO comprising a fresh issue worth Rs 8,010 crore, signalling that it intends to compete at scale for the foreseeable future regardless of the cost.`,
          `Dhindsa's argument is structural rather than speculative: there is a finite limit to how much further competitors can push subsidies without inflicting damage on their own financial positions that becomes genuinely unsustainable. Discount-driven customer acquisition often yields low-retention users who leave when promotions disappear. Durable advantages come from inventory selection, delivery speed, product quality, and user experience — not ever-deeper discounts.`,
          `Blinkit's own expansion into southern India provides a cautionary tale: discount-led growth delivered initial trials but failed to create repeat purchase behaviour, basket-size growth, or organic referrals. Meaningful improvement came only after focusing on service quality, dark store placement, local assortment, and operational reliability — investments that compound over time rather than evaporate when promotions stop.`,
          `Blinkit reported its fifth consecutive quarter of adjusted EBITDA improvement in Q1 FY27, with revenue up 18.4 per cent sequentially and net order value rising 19 per cent quarter on quarter. The company added 200 net new dark stores during Q1, taking its total network to 2,443 stores, and has invested approximately Rs 3,000 crore in stores and warehouses over four years. Under an inventory-led model, Blinkit owns stock to improve availability, pricing control, and customer experience — all contributors to retention.`,
          `If discounting moderates as Dhindsa predicts, contribution margins per order should recover, and capital currently spent on incentives can be redirected to infrastructure, technology, and category expansion. For investors, the end of the discount war makes unit economics legible enough to underwrite public market valuations. For consumers, it means paying prices closer to delivery cost and facing the question of whether behaviour formed under heavy discounts will persist.`,
          `Eternal reported a consolidated net profit of Rs 92 crore in Q1 FY27 and operating revenue of Rs 20,211 crore — results that give Dhindsa's comments credibility. Whether the quick commerce sector transitions smoothly away from subsidy-driven growth or whether discount-dependent competitors struggle is the defining story for the next year.`,
        ],
      },
      {
