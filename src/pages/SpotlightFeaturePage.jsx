...
const businessFeatureArticles = [
  ...
  },
  {
    ...
    body: [
      ...
      "The numbers are simultaneously encouraging and sobering. The glass ceiling has not been shattered so much as developed visible cracks, and the women creating those cracks deserve to be understood not as symbols or statistics but as strategists, operators, and institution-builders whose individual stories carry weight far beyond milestone headlines.",
      "Priya Nair took charge as MD and CEO of Hindustan Unilever in 2025, stepping into a role that no woman had held in the company's 92-year history in India. HUL had seen revenue and profit growth slow to single digits over two consecutive years, giving Nair a mandate not of maintenance but of transformation.",
      "Her strategic direction centres on building a company that is more modern, more desirable, and more youthful. That requires rethinking brand positioning, accelerating digital integration across HUL's sprawling portfolio, and reconnecting with younger consumers whose spending patterns, values, and media habits look very different from prior generations.",
      ...
      "Padalkar's leadership has been defined by expanding insurance access to underserved demographics, accelerating digital distribution and claims infrastructure, and building customer-centric solutions rather than relying only on product-led sales strategies.",
      ...
      "Before joining Aditya Birla Capital, Mulye spent two decades at ICICI Group, including a long stint as Executive Director at ICICI Bank where she oversaw wholesale banking, international operations, and corporate strategy. That background gives her a rare command of credit underwriting, capital allocation, risk management, and institutional financial architecture.",
      "At Aditya Birla Capital, she has focused on integrating the group's multiple financial businesses into a more cohesive consumer-facing platform while pushing its digital financial services arm into new consumer segments. The breadth of that mandate makes her role among the most complex in Indian financial services.",
      "Prabha Narasimhan's appointment as MD and CEO of Colgate-Palmolive India in 2022 carried a specific significance beyond the leadership milestone: she was the first person to lead the company from outside the organisation in twelve years.",
      "Narasimhan came from Hindustan Unilever, where she had spent close to two decades across sales, marketing, and consumer categories. At Colgate India, her priorities have centred on premiumisation, science-backed differentiation, and expanding higher-value oral care and personal care products in a market where consumer sophistication is rising quickly.",
      "Praveena Rai's career has moved through some of India's most consequential financial infrastructure institutions. At NPCI, she helped shape the digital payments backbone at a critical growth phase for UPI, leading marketing, business development, product management, and operational strategy.",
      "In 2024, Rai moved to MCX as MD and CEO, stepping into India's dominant commodity derivatives exchange. Her focus has been to bring a digital infrastructure mindset to market participation, exchange technology, and transparency across the commodities ecosystem.",
      ...
      "Her mandate has been to make that integration work operationally while driving the bank toward a larger growth agenda: a stronger capital base, broader geographic reach, and greater competitive standing across retail and corporate lending.",
      "The six women profiled here share careers built across decades, credibility earned through measurable outcomes, and resilience developed inside institutions where the pipeline to the top has historically been narrow. Of the 119 companies with women MDs or CEOs in 2026, most are still tied to promoter families, which shows how thin the professional leadership pipeline remains.",
      "There is one encouraging signal in the pipeline data: women independent directors are, on average, seven years younger than their male counterparts. Whether that translates into stronger CEO representation will depend on the choices companies, boards, and investors make about who gets access to roles that build future leadership track records.",
  ...
  },
  {
    ...
    body: [
      ...
      "Without the right autopilot, a drone is an expensive collection of components that cannot fly itself, navigate safely, respond to changing environments, or execute missions with the reliability that defence and commercial applications demand. With the right autopilot, a drone becomes a system.",
      ...
      "Conventional autopilot architectures rely on centralized processing, where a single computational unit manages all control decisions. The vulnerability is straightforward: if the central processor is compromised, overwhelmed, or jammed, the entire control system degrades or fails.",
      "DPCC takes a fundamentally different approach, distributing control computing across multiple parallel processors that operate in real time, sharing computational load and providing redundancy at the architecture level rather than through add-on failsafes.",
      ...
      "India's drone sector has operated for years under the shadow of DJI, whose consumer and commercial drones set difficult benchmarks on price and performance. For defence users, that dependency created risks beyond cost because Chinese-origin electronics are problematic in security-sensitive applications.",
      "Zuppa's response is the Ajeet Mini, positioned as a domestic alternative that can compete on pricing, features, and operational performance while eliminating the supply-chain and security risks associated with foreign drone hardware.",
      "The Ajeet Mini is not positioned as a compromise product for customers unable to access foreign alternatives. It is built to meet demanding operator standards while keeping the control intelligence sovereign by design.",
