...
const spotlightPages = {
  ...
  startup: {
    ...
    stories: [
      ...
      {
        slug: 'bad-boy-pizza-global-ambition',
        category: 'QSR STARTUP',
        ...
        image: '/ar.jpg',
        body: [
          "India's quick service restaurant sector is littered with celebrity-backed food ventures that launched with considerable fanfare and quietly receded when the novelty of the famous face wore off. Bad Boy Pizza, co-founded by rapper and music producer Badshah alongside veteran F&B entrepreneur Karan Tanna, was designed from its inception to be a different kind of story.",
          "Not a celebrity licensing arrangement. Not a name on a packaging box with someone else's product inside it. A genuinely built restaurant brand, with a culinary identity, an operational philosophy, and unit economics structured to work at scale.",
